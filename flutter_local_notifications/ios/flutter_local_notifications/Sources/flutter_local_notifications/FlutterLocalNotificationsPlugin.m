...
- (void)pendingNotificationRequests:(FlutterResult _Nonnull)result API_AVAILABLE
...
- (void)getActiveNotifications:(FlutterResult _Nonnull)result API_AVAILABLE
  ...
  [center getDeliveredNotificationsWithCompletionHandler:^(
    ...
    for (UNNotification *notification in notifications) {
      ...
      if (notification.request.content.targetContentIdentifier != nil) {
        activeNotification[TARGET_CONTENT_ID] =
            notification.request.content.targetContentIdentifier;
      }
...
- (void)checkPermissions:(NSDictionary *_Nonnull)arguments
                  result:(FlutterResult _Nonnull)result API_AVAILABLE
...
- (void)cancel:(NSDictionary *_Nonnull)arguments
        result:(FlutterResult _Nonnull)result API_AVAILABLE
  ...
  NSArray *idsToRemove =
      [[NSArray alloc] initWithObjects:[id stringValue], identifier, nil];
...
- (void)cancelAll:(FlutterResult _Nonnull)result API_AVAILABLE
...
- (void)addNotificationRequest:(NSString *)identifier
                       content:(UNMutableNotificationContent *)content
                        result:(FlutterResult _Nonnull)result
                       trigger:(UNNotificationTrigger *)trigger API_AVAILABLE
...
- (NSMutableDictionary *)extractNotificationResponseDict:
    (UNNotificationResponse *_Nonnull)response API_AVAILABLE
