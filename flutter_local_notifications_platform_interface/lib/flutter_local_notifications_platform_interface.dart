...
abstract class FlutterLocalNotificationsPlatform extends PlatformInterface {
  ...
  Future<void> periodicallyShow(int id, String? title, String? body, RepeatInterval repeatInterval) {
  ...
  Future<void> periodicallyShowWithDuration(int id, String? title, String? body, Duration repeatDurationInterval) {
